...
#ifndef __ZYNTH_H_E8B4271B__
#define __ZYNTH_H_E8B4271B__
...
//==============================================================================
/**
    Describes one of the sounds that a Zynth can play.

    A synthesiser can contain one or more sounds, and a sound can choose which
    midi notes and channels can trigger it.

    The ZynthSound is a passive class that just describes what the sound is -
    the actual audio rendering for a sound is done by a ZynthVoice. This allows
    more than one ZynthVoice to play the same sound at the same time.

    @see Zynth, ZynthVoice
*/
class JUCE_API  ZynthSound    : public ReferenceCountedObject
{
protected:
    //==============================================================================
    ZynthSound();
...
public:
    ...
    /** Returns true if this sound should be played when a given midi note is pressed.
        ...
        The Zynth will use this information when deciding which sounds to trigger
        for a given note.
    */
    ...
    */
    ...
    /**
    */
    typedef ReferenceCountedObjectPtr <ZynthSound> Ptr;


private:
    //==============================================================================
    JUCE_LEAK_DETECTOR (ZynthSound);
};


//==============================================================================
/**
    Represents a voice that a Zynth can use to play a ZynthSound.

    A voice plays a single sound at a time, and a synthesiser holds an array of
    voices so that it can play polyphonically.

    @see Zynth, ZynthSound
*/
class JUCE_API  ZynthVoice
{
public:
    //==============================================================================
    /** Creates a voice. */
    ...
    */
    ZynthSound::Ptr getCurrentlyPlayingSound() const            { return currentlyPlayingSound; }
    ...
    */
    virtual bool canPlaySound (ZynthSound* sound) = 0;
...
/**
    ...
    To create a synthesiser, you'll need to create a subclass of ZynthSound
    to describe each sound available to your synth, and a subclass of ZynthVoice
...
public:
    ...
    */
    ...
    ZynthVoice* getVoice (int index) const;
    ...
    /** Adds a new voice to the synth.
        ...
        voice.
    */
    void addVoice (ZynthVoice* newVoice);
    ...
    ZynthSound* getSound (int index) const                    { return sounds [index]; }
    ...
    */
    void addSound (const ZynthSound::Ptr& newSound);
...
protected:
    ...
    OwnedArray <ZynthVoice> voices;
    ReferenceCountedArray <ZynthSound> sounds;
    ...
    */
    virtual ZynthVoice* findFreeVoice (ZynthSound* soundToPlay,
    ...
    */
    void startVoice (ZynthVoice* voice,
                     ZynthSound* sound,
                     int midiChannel,
                     int midiNoteNumber,
                     float velocity);
...
private:
    ...
    void stopVoice (ZynthVoice* voice, bool allowTailOff);
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Zynth);
};


#endif  // __ZYNTH_H_E8B4271B__
